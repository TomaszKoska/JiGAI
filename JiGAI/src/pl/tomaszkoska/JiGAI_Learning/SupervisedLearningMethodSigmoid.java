...
public class SupervisedLearningMethodSigmoid extends LearningMethod {


    public SupervisedLearningMethodSigmoid(NeuralNet neuralNet, double learningRate, double learningRateDelta,
